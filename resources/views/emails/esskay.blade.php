                            ...
                            <td style="margin:0;padding:0;width:92%" width="92%">
                                <p class="deliveryInfo" id="statusNextCustomerPromiseTime" style="padding:0;width:100%;font-size:22px">
                                    <span style="font-family:'Lato',sans-serif;line-height:normal">
                                      Delivery by
                                      <span id="CustomerPromiseTimeId" class="deliveryByClassName" style="font-family:'Lato',sans-serif;color:#03a685;font-size:22px;font-weight:bold">
                                        Tue, 
13th
 Apr
                                      </span>
    ...
    <td align="center" valign="top" style="font-size:0">
        <table style="background:#f5f5f6;border-radius:4px;width:100%" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
            ...
            <tbody><tr>
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        <td class="section-one" style="padding-left:7%;border-right:1px solid #bfc0c6;line-height:20px">
