@if($sanctionLetterData)
	<table class="table">
		...
		<tr>
			...
			<td class="mtdd-sanction-letter-img"><a href="{{ asset('/') }}downloadsanctionLetter/{{ base64_encode($sanctionLetterData['id']) }}" target="_blank"><i class="fa fa-2x fa-file-{{ $sanctionLetterData['ext'] }}-o" aria-hidden="true"></i></a></td>
		</tr>
		<tr>
