						...
						<div class="custom-table-area">
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th class="text-justify" style="width: 280px;">Name of the Director</th>
											<th class="border-bottom" style="width: 220px;">Status</th>
									...
									<tbody>
										...
										<tr>
											<td class="text-justify" style="width: 280px;">{{ $row->director_name }}</td>
