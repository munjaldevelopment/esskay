@if ($crud->hasAccess('checker_transaction') && $entry->transaction_status == 0)
	...
	<a href="javascript:void(0)" onclick="checkerTransactionRejectEntry(this)" data-route="{{ backpack_url('checkerTransactionReject/'.$entry->getKey()) }}" class="btn btn-sm btn-link" data-button-type="checkerDocument"><i class="la la-times"></i> {{ trans('backpack::crud.rejectTransaction') }}</a>
@endif
