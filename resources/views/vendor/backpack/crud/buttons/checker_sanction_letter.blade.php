@if (($crud->hasAccess('checker_sanction_letter1') || $crud->hasAccess('checker_sanction_letter2') || $crud->hasAccess('checker_sanction_letter3')))
	@if(($crud->hasAccess('checker_sanction_letter1')) && ($entry->is_approve1 == 0))
	<a href="javascript:void(0)" onclick="checkersanctionLetterEntry(this)" data-route="{{ backpack_url('checkerSanctionLetter/'.$entry->getKey()) }}" class="btn btn-sm btn-link" data-button-type="checkerDocument"><i class="la la-check"></i> {{ $entry->is_approve1 }} {{ trans('backpack::crud.checkerSanctionLetter') }}</a>
	...
	@if(($crud->hasAccess('checker_sanction_letter2')) && ($entry->is_approve2 == 0))
	<a href="javascript:void(0)" onclick="checkersanctionLetterEntry(this)" data-route="{{ backpack_url('checkerSanctionLetter2/'.$entry->getKey()) }}" class="btn btn-sm btn-link" data-button-type="checkerDocument"><i class="la la-check"></i> {{ $entry->is_approve2 }} {{ trans('backpack::crud.checkerSanctionLetter2') }}</a>
	...
	@if(($crud->hasAccess('checker_sanction_letter3')) && ($entry->is_approve3 == 0))
	<a href="javascript:void(0)" onclick="checkersanctionLetterEntry(this)" data-route="{{ backpack_url('checkerSanctionLetter3/'.$entry->getKey()) }}" class="btn btn-sm btn-link" data-button-type="checkerDocument"><i class="la la-check"></i> {{ $entry->is_approve3 }} {{ trans('backpack::crud.checkerSanctionLetter3') }}</a>
