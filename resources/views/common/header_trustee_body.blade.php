		...
		<nav class="navbar navbar-expand-md">
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav ml-auto nav-custome">
					...
					<li class="operation-li"><h5 class="custome-syle">{{ $trusteeData->name }}<span class="inner-inner">({{ substr($trusteeData->name, 1) }})</span></h5>
						<div class="onbrd-btn">
					...
					<li class="nav-item dropdown pr-0">
						<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
							<span class="mr-1 rounded-circle heading-jhone">{{ $trusteeCode }}</span>
						</a>
