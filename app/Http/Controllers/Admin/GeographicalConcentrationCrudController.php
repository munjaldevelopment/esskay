...
class GeographicalConcentrationCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/geographicalconcentration');
        CRUD::setEntityNameStrings('geographicalconcentration', 'geographical_concentrations');
    }
