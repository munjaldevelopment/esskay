 ...
 */
class RejectSanctionLetterCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/reject_sanction_letter');
        CRUD::setEntityNameStrings('RejectSanction Letter', 'Reject Sanction Letters');
