 ...
 */
class AcceptDocumentCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/accept_document');
        CRUD::setEntityNameStrings('Accept document', 'Accept documents');
		...
		if($list_document)
		{
            ...
            $this->crud->addClause('where', 'document_status', '=', "1");
