...
class StrongLiabilityProfileOverallCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if($list_strong_liability_profile_overall)
        {
            ...
            $checker_strong_liability_profile_overall = backpack_user()->hasPermissionTo('checker_strong_liability_profile_overall');

            if($checker_strong_liability_profile_overall)
            {
                $is_admin = backpack_user()->hasRole('Super Admin');
                if($is_admin)
                {
                    $this->crud->allowAccess(['checker_strong_liability_profile_overall', 'revise', 'delete']);
                }
                else
                {
                    if($checker_strong_liability_profile_overall)
                    {
                        ...
                        $this->crud->allowAccess(['checker_strong_liability_profile_overall']);
                    }
                }
            }
            else
            {
                $this->crud->denyAccess(['checker_strong_liability_profile_overall', 'revise', 'delete']);
            }
            ...
            $this->crud->addButtonFromView('line', 'checker_strong_liability_profile_overall', 'checker_strong_liability_profile_overall', 'end');
