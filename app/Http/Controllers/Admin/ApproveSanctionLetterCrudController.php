 ...
 */
class ApproveSanctionLetterCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/approve_sanction_letter');
        CRUD::setEntityNameStrings('Approve Sanction Letter', 'Approve Sanction Letters');
