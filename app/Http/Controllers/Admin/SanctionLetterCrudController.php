...
class SanctionLetterCrudController extends CrudController
{
    ...
    public function store()
    {
        ...
        if($sms_status)
        {
            $message = str_replace(" ", "%20", "Dear Sir, Saction Letter of ".$facility_amount." from ".$bank_name." is initialized. Kindly click on below link for the details ".backpack_url('sanction_letter/'.$sanction_letter_id."/show")." \r\n ESS KAY FINCORP LIMITED.");
    ...
    public function update()
    {
        ...
        if($sms_status)
        {
            $message = str_replace(" ", "%20", "Dear Sir, Saction Letter of ".$facility_amount." from ".$bank_name." is updated. Kindly click on below link for the details ".backpack_url('sanction_letter/'.$sanction_letter_id."/show")."  \r\n ESS KAY FINCORP LIMITED.");
            $lender_phone = "9462045321";
