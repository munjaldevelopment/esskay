...
class GeographicalConcentrationSheetImport implements ToCollection, WithValidation, WithHeadingRow
{
	use Importable;
	...
	{
		//dd($rows);
		/*geographical_diversification" => "Rajasthan"
        "docp" => "Nov-94"
        "mar_16_amount" => 441
		...
		\DB::table('geographical_concentrations')->truncate();
		...
		foreach($rows as $row)
		{
			...
			$lenderBanking->geographical_concentration_status = ($row['status'] == "Yes" ? "1" : "0");
			$lenderBanking->save();
		}
    }	
	...
	public function customValidationMessages()
	{
		return [
			...
			'docp' => 'Message 3.',
			'mar_16_amount' => 'Message 4.',
			'mar_16_amount_percent' => 'Message 5.',
            'status' => 'Message 21.',
		];
	}
