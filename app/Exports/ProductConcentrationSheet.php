...
class ProductConcentrationSheet implements FromArray, WithTitle, WithHeadings, ShouldAutoSize
{
	...
	public function array(): array
    {
		...
		if($factories){
			foreach($factories as $k => $factory)
			{
				$factoryData[$k] = array(
					'ID' => $factory['id'],
					'Product Diversification' => $factory['product_diversification'],
		            ...
		            'Status' => ($factory['product_concentration_status'] ? "Yes" : "No"));
			}
		}
